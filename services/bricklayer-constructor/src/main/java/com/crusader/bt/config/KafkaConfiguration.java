...
public class KafkaConfiguration {
    ...
    @Bean
    public KafkaReceiver<String, MessageDto> constructorMessageReceiver() {
    ...
    private Map<String, Object> buildConsumerFactoryConfig(KafkaProperties details,
        ...
        props.put(ConsumerConfig.GROUP_ID_CONFIG, topicInfo.getClientNGroupId());
        props.put(ConsumerConfig.CLIENT_ID_CONFIG, topicInfo.getClientNGroupId());
    ...
    private Map<String, Object> buildProducerFactoryConfig(KafkaProperties details,
        ...
        props.put(ProducerConfig.CLIENT_ID_CONFIG, topicInfo.getClientNGroupId());
